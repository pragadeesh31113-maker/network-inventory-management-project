...
// ... other imports
import TopologyPageWrapper from './pages/TopologyPage'; // <-- FIXED IMPORT
  ...
  return (
    <InternalLayout>
      <Routes>
        ...
        {/* --- ADDED THIS LINE --- */}
        <Route path="/topology" element={<TopologyPageWrapper />} />
...
// import { SignUpPage } from './pages/SignUpPage';
// // ... other imports
// import { TopologyPage } from './pages/TopologyPage'; // <-- Add this
