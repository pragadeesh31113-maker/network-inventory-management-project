// frontend/src/components/network_map/CustomerONTNode.tsx
import React, { memo } from 'react';
import { Handle, Position } from 'reactflow';
import { Box, Typography, Paper } from '@mui/material';
import RouterIcon from '@mui/icons-material/Router'; // Can represent ONT/Router generally
import FiberManualRecordIcon from '@mui/icons-material/FiberManualRecord'; // For active status

const CustomerONTNode = ({ data }: { data: { label: string; details?: string; deviceType?: string; status?: string } }) => {
...
export default memo(CustomerONTNode);